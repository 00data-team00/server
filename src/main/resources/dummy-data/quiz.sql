...
(2, '음성/단어 매칭', '음성을 듣고 해당하는 의미의 단어를 선택해주세요!', NULL, '한 명의 소리꾼이 고수의 북 반주에 맞춰 이야기를 노래로 들려주는 한국의 전통 음악', 1, NULL),
...
(3, '음성/단어 매칭', '음성을 듣고 해당하는 의미의 단어를 선택해주세요!', NULL, '발과 주먹을 사용하는 한국의 전통 무술이자 올림픽 정식 종목', 1, NULL);
